...
// The function returns a number...
{
	...
	scnrm2( x.length, x, 1 ); // $ExpectType number
}
...
// The compiler throws an error if the function is provided a first argument which is not a number...
{
	...
	scnrm2( '10', x, 1 ); // $ExpectError
	scnrm2( true, x, 1 ); // $ExpectError
	scnrm2( false, x, 1 ); // $ExpectError
	scnrm2( null, x, 1 ); // $ExpectError
	scnrm2( undefined, x, 1 ); // $ExpectError
	scnrm2( [], x, 1 ); // $ExpectError
	scnrm2( {}, x, 1 ); // $ExpectError
	scnrm2( ( x: number ): number => x, x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the function is provided a second argument which is not a Complex64Array...
{
	...
	scnrm2( x.length, 10, 1 ); // $ExpectError
	scnrm2( x.length, '10', 1 ); // $ExpectError
	scnrm2( x.length, true, 1 ); // $ExpectError
	scnrm2( x.length, false, 1 ); // $ExpectError
	scnrm2( x.length, null, 1 ); // $ExpectError
	scnrm2( x.length, undefined, 1 ); // $ExpectError
	scnrm2( x.length, [], 1 ); // $ExpectError
	scnrm2( x.length, {}, 1 ); // $ExpectError
	scnrm2( x.length, ( x: number ): number => x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the function is provided a third argument which is not a number...
{
	...
	scnrm2( x.length, x, '10' ); // $ExpectError
	scnrm2( x.length, x, true ); // $ExpectError
	scnrm2( x.length, x, false ); // $ExpectError
	scnrm2( x.length, x, null ); // $ExpectError
	scnrm2( x.length, x, undefined ); // $ExpectError
	scnrm2( x.length, x, [] ); // $ExpectError
	scnrm2( x.length, x, {} ); // $ExpectError
	scnrm2( x.length, x, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the function is provided an unsupported number of arguments...
{
	...
	scnrm2(); // $ExpectError
	scnrm2( x.length ); // $ExpectError
	scnrm2( x.length, x ); // $ExpectError
	scnrm2( x.length, x, 1, 10 ); // $ExpectError
}
